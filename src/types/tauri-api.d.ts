/**
 * This module is a copy of the original '@tauri-apps/api/tauri' module.
...
module '@tauri-apps/api/tauri' {
	 ...
	 * @since 1.0.0
	 */
	declare function transformCallback(
	...
	export declare function invoke<C extends Command>(
		cmd: C,
		args: CommandArgs<C>
	 ...
	 * @since 1.0.0
	 */
	declare function invoke<C>(cmd: C, args?: CommandArgs<C>): CommandReturn<C>;
	/**
